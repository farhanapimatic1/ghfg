...
module AwseCommerceService
  # BrowseNodeLookup Model.
  class BrowseNodeLookup < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of BrowseNodeLookupRequest]
    ...
    def self.from_hash(hash)
      ...
      shared = BrowseNodeLookupRequest.from_hash(hash['Shared']) if
        hash['Shared']
      ...
      unless hash['Request'].nil?
        ...
        hash['Request'].each do |structure|
          request << (BrowseNodeLookupRequest.from_hash(structure) if structure)
        end
      end

      # Create object from extracted values.
      BrowseNodeLookup.new(marketplace_domain,
                           aws_access_key_id,
                           associate_tag,
                           validate,
                           xml_escaping,
