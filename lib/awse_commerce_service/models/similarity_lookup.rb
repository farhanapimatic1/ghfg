...
module AwseCommerceService
  # SimilarityLookup Model.
  class SimilarityLookup < BaseModel
    ...
    # TODO: Write general description for this method
    # @return [List of SimilarityLookupRequest]
    ...
    def self.from_hash(hash)
      ...
      shared = SimilarityLookupRequest.from_hash(hash['Shared']) if
        hash['Shared']
      ...
      unless hash['Request'].nil?
        ...
        hash['Request'].each do |structure|
          request << (SimilarityLookupRequest.from_hash(structure) if structure)
        end
      end

      # Create object from extracted values.
      SimilarityLookup.new(marketplace_domain,
                           aws_access_key_id,
                           associate_tag,
                           validate,
                           xml_escaping,
